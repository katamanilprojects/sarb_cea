...
if (!empty($_POST['sub_id']) && !empty($_POST['assessment_number']) && !empty($_POST['secretcode']) && $_POST['secretcode'] == $_SESSION['secretcode'] && !empty($_POST['submit_action'])) {
    ...
    if ($submitAction == 'save') {
        ...
        foreach ($_POST['student_id'] as $index => $studentId) {
            ...
            if ($activity_marks > 15 || $internal_test_marks > 15 || !is_numeric($activity_marks) || !is_numeric($internal_test_marks)) {
        ...
        form.onsubmit = function(e) {
            ...
            if (submitButton.clicked) {
                ...
                daytodayInputs.forEach((input, index) => {
                    ...
                    if (
                        isNaN(activity_marks) || activity_marks > 15 || activity_marks < 0 ||
                        ...
                        if (!firstInvalidInput) {
                            ...
                            } else if (isNaN(activity_marks) || activity_marks > 15 || activity_marks < 0) {
                                firstInvalidInput = input;
                            }
                        }

                        // Apply red border to invalid fields
                        if (isNaN(activity_marks) || activity_marks > 15 || activity_marks < 0) {
