        ...
        <div class="col-sm-12">
            <div class="card">
                ...
                <div class="card-body dontprint">
                    <form action="hodshowallclsattendance.php" method="post" id="showsarbform">
            ...
            if (!empty($_POST['action']) && $_POST['action'] == "view_all_overall" && $csrfcheck==1) {
                // Ensure selected_cls_id is set from POST data
                if (!empty($_POST['cls_id'])) {
                    $selected_cls_id = $_POST['cls_id'];
                }
                ...
                echo '<form action="download_cls_cia.php" method="post" class="dontprint"><input type="hidden" name="secretcode" value="' . $_SESSION['secretcode'] . '"><input type="hidden" name="cls_id" value="' . $selected_cls_id . '"><button type="submit" name="action" value="admin_export_cia_marks" class="btn btn-primary">View Overall CIA</button></form>';            
