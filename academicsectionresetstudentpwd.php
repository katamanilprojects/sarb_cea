    ...
    if (!empty($_POST['secretcode']) && !empty($_SESSION['secretcode']) && $_POST['secretcode'] == $_SESSION['secretcode']) {
        ...
        if (!empty($_POST['action']) && $_POST['action'] == 'fetch') {
            ...
            if (!empty($_SESSION['reset_username'])) {
                ...
                $res = $obj->resetStudentPwd($username, $remarks);
                if (!empty($res['status']) && $res['status'] == 1) {
                    $success = "Password Reset Successfully!<br/>Default password is student's Roll Number / Username.";
            ...
            <div class="row">
                ...
                <div class="col-sm-8">
                    ...
                    <?php if ($step == 1) { ?>
                        ...
                        <form action="academicsectionresetstudentpwd.php" method="post">
                            ...
                            <a href="academicsectionhome.php" class="btn btn-secondary">Cancel</a>
                        </form>
                    <?php } elseif ($step == 2 && !empty($student_details)) { ?>
                        ...
                        <form action="academicsectionresetstudentpwd.php" method="post">
                            ...
                            <div class="alert alert-warning">
                                <strong>Default Password:</strong> Student's Roll Number/Username<br>                             
                            </div>
                            ...
                            <a href="academicsectionresetstudentpwd.php" class="btn btn-secondary">Reset Form</a>
                        </form>
                    <?php } ?>
                </div>
                <div class="col-sm-2"></div>
